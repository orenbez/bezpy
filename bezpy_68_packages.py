...
# after version 3.3.  the __init__.py is only required if you wish to
# use an initialization script when importing a package but not strictly necessary
...
# You can also place an import inside a method or function
